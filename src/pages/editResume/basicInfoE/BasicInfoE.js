    ...
    <>
      <div className="basicInfo_fields">
        <div className="basicInfo_inputbox_devide">
          ...
          >
            ...
            />
            {validationErrors?.nativePlace && (
              <div className="error-text">{validationErrors?.nativePlace}</div>
            )}
          </div>
          {/* Last Name */}
          <div
          ...
          >
            ...
            />
            {validationErrors.middleName && (
              <div className="error-text">{validationErrors.middleName}</div>
            )}
          </div>
          {/* Date of Birth */}
          <div
      ...
      <div className="basicInfo_fields_upload_image">
        <div className="basicInfo_inputbox_devide_upload_image">
          ...
          >
            <span className={formData?.images?.length > 0 ? "green-text" : ""}>
